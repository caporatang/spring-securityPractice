...
public class BasicAuthenticationTest {
    ...
    void test_4() {
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");
        ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(), "taeil", String.class);
        assertEquals("hello taeil", resp.getBody());
    }
